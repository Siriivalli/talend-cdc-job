...
package talend3.cdc_project_0_1;
...
/**
 * Job: CDC_Project Purpose: <br>
 * Description:  <br>
 * @author Sirivalli, Ladella
 * @version 8.0.1.20250423_1207-patch
 * @status 
 */
public class CDC_Project implements TalendJob {
	static {System.setProperty("TalendJob.log", "CDC_Project.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(CDC_Project.class);
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "CDC_Project";
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_Gdmi8GfPEfCPtsDXIeZX_A", "0.1");
...
private class TalendException extends Exception {
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TalendException)) {
			CDC_Project.this.exception = e;
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(CDC_Project.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
		...
		if(enableLogStash) {
			...
			public void cdcHashJoblet_3_tMap_1_error(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
...
public static class InsertRecordsStruct implements routines.system.IPersistableRow<InsertRecordsStruct> {
    final static byte[] commonByteArrayLock_TALEND3_CDC_Project = new byte[0];
    static byte[] commonByteArray_TALEND3_CDC_Project = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_TALEND3_CDC_Project.length) {
				if(length < 1024 && commonByteArray_TALEND3_CDC_Project.length == 0) {
   					commonByteArray_TALEND3_CDC_Project = new byte[1024];
				} else {
   					commonByteArray_TALEND3_CDC_Project = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_TALEND3_CDC_Project, 0, length);
			strReturn = new String(commonByteArray_TALEND3_CDC_Project, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_TALEND3_CDC_Project, 0, length);
			strReturn = new String(commonByteArray_TALEND3_CDC_Project, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_TALEND3_CDC_Project) {
...
public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	final boolean execStat = this.execStat;
		...
		mdc("tFileInputDelimited_1", "5pMvOl_");
 ...
 */
                ...
                class BytesLimit65535_tFileInputDelimited_1{
                    ...
                    log4jParamters_tFileInputDelimited_1.append("Parameters:");
                        ...
                        log4jParamters_tFileInputDelimited_1.append(" | ");
                            log4jParamters_tFileInputDelimited_1.append("FILENAME" + " = " + "\"D:/fs/talend/talend/customers_source.csv\"");
                        log4jParamters_tFileInputDelimited_1.append(" | ");
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				try{
						...
						Object filename_tFileInputDelimited_1 = "D:/fs/talend/talend/customers_source.csv";
			...
			if(footer_value_tFileInputDelimited_1 >0 || random_value_tFileInputDelimited_1 > 0){
				throw new java.lang.Exception("When the input source is a stream,footer and random shouldn't be bigger than 0.");				
						...
						try {
							fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited("D:/fs/talend/talend/customers_source.csv", "ISO-8859-15",",","\n",true,1,0,
 ...
 */
	...
	s(currentComponent="tFileInputDelimited_1");
                ...
                if(!((Object)("D:/fs/talend/talend/customers_source.csv") instanceof java.io.InputStream)){
...
public void tFileInputDelimited_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	final boolean execStat = this.execStat;
		...
		mdc("tFileInputDelimited_2", "NekvOq_");
		...
		int tos_count_tAdvancedHash_row4 = 0;
			...
			if(enableLogStash) {
				...
				s(currentComponent);
			   		...
			   		// source node:cdcHashJoblet_3_tMap_1 - inputs:(row2) outputs:(row4,row4) | target node:tAdvancedHash_row4 - inputs:(row4) outputs:()
 ...
 */
	...
	/**
	 * [cdcHashJoblet_3_tMap_1 begin ] start
	 */
		...
		sh("cdcHashJoblet_3_tMap_1");
		
	
	s(currentComponent="cdcHashJoblet_3_tMap_1");
		...
		int tos_count_cdcHashJoblet_3_tMap_1 = 0;
		
                if(log.isDebugEnabled())
            log.debug("cdcHashJoblet_3_tMap_1 - "  + ("Start to work.") );
            if (log.isDebugEnabled()) {
                class BytesLimit65535_cdcHashJoblet_3_tMap_1{
                    public void limitLog4jByte() throws Exception{
                    StringBuilder log4jParamters_cdcHashJoblet_3_tMap_1 = new StringBuilder();
                    log4jParamters_cdcHashJoblet_3_tMap_1.append("Parameters:");
                            log4jParamters_cdcHashJoblet_3_tMap_1.append("LINK_STYLE" + " = " + "AUTO");
                        log4jParamters_cdcHashJoblet_3_tMap_1.append(" | ");
                            log4jParamters_cdcHashJoblet_3_tMap_1.append("TEMPORARY_DATA_DIRECTORY" + " = " + "");
                        log4jParamters_cdcHashJoblet_3_tMap_1.append(" | ");
                            log4jParamters_cdcHashJoblet_3_tMap_1.append("ROWS_BUFFER_SIZE" + " = " + "2000000");
                        log4jParamters_cdcHashJoblet_3_tMap_1.append(" | ");
                            log4jParamters_cdcHashJoblet_3_tMap_1.append("CHANGE_HASH_AND_EQUALS_FOR_BIGDECIMAL" + " = " + "true");
                        log4jParamters_cdcHashJoblet_3_tMap_1.append(" | ");
                if(log.isDebugEnabled())
            log.debug("cdcHashJoblet_3_tMap_1 - "  + (log4jParamters_cdcHashJoblet_3_tMap_1) );
                    } 
                } 
            new BytesLimit65535_cdcHashJoblet_3_tMap_1().limitLog4jByte();
            }
			if(enableLogStash) {
				talendJobLog.addCM("cdcHashJoblet_3_tMap_1", "tMap_1", "tMap");
				talendJobLogProcess(globalMap);
				s(currentComponent);
			}
...
// ###############################
// # Lookup's keys initialization
		int count_row2_cdcHashJoblet_3_tMap_1 = 0;
...
// ###############################
// # Outputs initialization
				int count_row4_cdcHashJoblet_3_tMap_1 = 0;
...
/**
 * [cdcHashJoblet_3_tMap_1 begin ] stop
 */
                ...
                class BytesLimit65535_tFileInputDelimited_2{
                    ...
                    log4jParamters_tFileInputDelimited_2.append("Parameters:");
                        ...
                        log4jParamters_tFileInputDelimited_2.append(" | ");
                            log4jParamters_tFileInputDelimited_2.append("FILENAME" + " = " + "\"D:/fs/talend/talend/customers_target.csv\"");
                        log4jParamters_tFileInputDelimited_2.append(" | ");
	...
	final routines.system.RowState rowstate_tFileInputDelimited_2 = new routines.system.RowState();
				...
				try{
						...
						Object filename_tFileInputDelimited_2 = "D:/fs/talend/talend/customers_target.csv";
			...
			if(footer_value_tFileInputDelimited_2 >0 || random_value_tFileInputDelimited_2 > 0){
				throw new java.lang.Exception("When the input source is a stream,footer and random shouldn't be bigger than 0.");				
						...
						try {
							fid_tFileInputDelimited_2 = new org.talend.fileprocess.FileInputDelimited("D:/fs/talend/talend/customers_target.csv", "ISO-8859-15",",","\n",true,1,0,
...
if(row2 != null) { 
	...
	/**
	 * [cdcHashJoblet_3_tMap_1 main ] start
	 */
	...
	s(currentComponent="cdcHashJoblet_3_tMap_1");
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row2","tFileInputDelimited_2","tFileInputDelimited_2","tFileInputDelimited","cdcHashJoblet_3_tMap_1","tMap_1","tMap"
		...
		boolean hasCasePrimitiveKeyWithNull_cdcHashJoblet_3_tMap_1 = false;
		
		// ###############################
		// # Input tables (lookups)
		
		boolean rejectedInnerJoin_cdcHashJoblet_3_tMap_1 = false;
		boolean mainRowRejected_cdcHashJoblet_3_tMap_1 = false;
		// ###############################
        { // start of Var scope
...
// # Output table : 'row4'
count_row4_cdcHashJoblet_3_tMap_1++;
...
row4 = row4_tmp;
log.debug("cdcHashJoblet_3_tMap_1 - Outputting the record " + count_row4_cdcHashJoblet_3_tMap_1 + " of the output table 'row4'.");

// ###############################

} // end of Var scope

rejectedInnerJoin_cdcHashJoblet_3_tMap_1 = false;
	...
	tos_count_cdcHashJoblet_3_tMap_1++;

		

/**
 * [cdcHashJoblet_3_tMap_1 main ] stop
 */

	
	/**
	 * [cdcHashJoblet_3_tMap_1 process_data_begin ] start
	 */
...
/**
 * [cdcHashJoblet_3_tMap_1 process_data_begin ] stop
 */
...
if(row4 != null) { 
	...
	s(currentComponent="tAdvancedHash_row4");
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row4","cdcHashJoblet_3_tMap_1","tMap_1","tMap","tAdvancedHash_row4","tAdvancedHash_row4","tAdvancedHash"
 ...
 */
	...
	/**
	 * [cdcHashJoblet_3_tMap_1 process_data_end ] start
	 */
...
/**
 * [cdcHashJoblet_3_tMap_1 process_data_end ] stop
 */
 ...
 */
	...
	s(currentComponent="tFileInputDelimited_2");
                ...
                if(!((Object)("D:/fs/talend/talend/customers_target.csv") instanceof java.io.InputStream)){
 ...
 */
	...
	/**
	 * [cdcHashJoblet_3_tMap_1 end ] start
	 */
...
// # Lookup hashes releasing
// ###############################      
				log.debug("cdcHashJoblet_3_tMap_1 - Written records count in the table 'row4': " + count_row4_cdcHashJoblet_3_tMap_1 + ".");
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"row2",2,0,
			 			"tFileInputDelimited_2","tFileInputDelimited_2","tFileInputDelimited","cdcHashJoblet_3_tMap_1","tMap_1","tMap","output")) {
						talendJobLogProcess(globalMap);
					}
				
 
                if(log.isDebugEnabled())
            log.debug("cdcHashJoblet_3_tMap_1 - "  + ("Done.") );

ok_Hash.put("cdcHashJoblet_3_tMap_1", true);
end_Hash.put("cdcHashJoblet_3_tMap_1", System.currentTimeMillis());
...
/**
 * [cdcHashJoblet_3_tMap_1 end ] stop
 */
...
tHash_Lookup_row4.endPut();
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"row4",2,0,
			 			"cdcHashJoblet_3_tMap_1","tMap_1","tMap","tAdvancedHash_row4","tAdvancedHash_row4","tAdvancedHash","output")) {
						talendJobLogProcess(globalMap);
					}
 ...
 */
	...
	/**
	 * [cdcHashJoblet_3_tMap_1 finally ] start
	 */
...
/**
 * [cdcHashJoblet_3_tMap_1 finally ] stop
 */
 ...
 */
    ...
    public static void main(String[] args){
        final CDC_Project CDC_ProjectClass = new CDC_Project();

        int exitCode = CDC_ProjectClass.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'CDC_Project' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
	        ...
	        getjobInfo();
			log.info("TalendJob: 'CDC_Project' - Start.");
                ...
                org.slf4j.MDC.put("_jobRepositoryId","_Gdmi8GfPEfCPtsDXIeZX_A");
                org.slf4j.MDC.put("_compiledAtTimestamp","2025-07-23T14:29:59.843023400Z");
        ...
        try {
            ...
            java.io.InputStream inContext = CDC_Project.class.getClassLoader().getResourceAsStream("talend3/cdc_project_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = CDC_Project.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
        ...
        resumeUtil.addLog("JOB_STARTED", "JOB:" + jobName, parent_part_launcher, Thread.currentThread().getId() + "", "","","","",resumeUtil.convertToJsonText(context,ContextProperties.class,parametersToEncrypt));
            ...
            log.info("TalendJob: 'CDC_Project' - Started.");
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : CDC_Project");
        }
		if(enableLogStash) {
...
if (execStat) {
    ...
    resumeUtil.flush();
        ...
        log.info("TalendJob: 'CDC_Project' - Finished - status: " + status + " returnCode: " + returnCode );
...
/************************************************************************************************
 *     228637 characters generated by Talend Cloud Data Management Platform 
 *     on the 23 July 2025 at 7:59:59 pm IST
 ************************************************************************************************/